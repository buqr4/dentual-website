...
(function () {
    ...
    const REVIEWS = [
        { name: 'Havva Nur Ünal', initials: 'HÜ', color: '#0a3f3c', stars: 5, tag: 'Genel Tedavi', tagEn: 'General Treatment', text: 'Geçen yazdan beri Sena Hocam\'a birçok farklı diş tedavisi için gittim (kanal, dolgu, kaplama, gece plağı gibi). Bütün tedavilerde çok ilgili ve özenli yaklaştı, sorunsuz bir şekilde bütün diş tedavilerimi yaptı. Sena Hocam ve ekibine ilgileri için çok teşekkür ederim.', textEn: 'Since last summer I have gone to Dr. Sena for many different treatments (root canal, fillings, crowns, night guard). She was attentive and meticulous in every one and completed all my treatments smoothly. Many thanks to Dr. Sena and her team for their care.' },
        { name: 'Sevil Esmer', initials: 'SE', color: '#14b8a6', stars: 5, tag: 'Hasta Yaklaşımı', tagEn: 'Patient Care', text: 'O kadar çok diş hekimine gittim, diş yaptırmaktan çok korkuyordum. Sayın Zuhal Karataş Hoca tüm korkularımı yenmemde etkili oldu. Hastasına güleryüzlü ve itinalı yaklaşımı muhteşem. Gördüğüm en iyi, en mükemmel diş hekimidir; herkese tavsiye ediyorum.', textEn: 'I had been to so many dentists and was terribly afraid of dental work. Dr. Zuhal Karataş helped me overcome all my fears. Her warm, careful approach to patients is wonderful. She is the best, most excellent dentist I have seen — I recommend her to everyone.' },
        { name: 'Gökhan Karaman', initials: 'GK', color: '#11665f', stars: 5, tag: 'Aile Diş Sağlığı', tagEn: 'Family Dental Care', text: 'Zuhal hoca ile çocuklarımın diş problemleri için tanıştık. Kızımın korkusunu yenmesi için sabırla yaklaşıp işlemleri sorunsuz halletti. Artık ailemizin diş hekimi oldu. Kendi ve eşimin yaptırdığı dolgu ve kaplamadan da çok memnunuz. Kararsız kaldıysanız şiddetle tavsiye ederim.', textEn: 'We met Dr. Zuhal for my children\'s dental problems. She patiently helped my daughter overcome her fear and handled everything smoothly. She is now our family dentist. We are also very pleased with the fillings and crowns she did for me and my wife. If you are undecided, I highly recommend her.' },
        { name: 'Furkan Hakyemez', initials: 'FH', color: '#0d4d4d', stars: 5, tag: 'Şeffaf Plak', tagEn: 'Clear Aligner', text: 'Ortodontist Uzm. Dt. Esra Pilancı\'ya şeffaf plak tedavisi ve çene eklemi problemi için muayene oldum. Samimi yaklaşımı ve ayrıntılı bilgilendirmeleri sayesinde tüm sorularıma eksiksiz cevap buldum. Diş ve çene tedavisi olacaklara Esra Hanım\'ı şiddetle tavsiye ediyorum.', textEn: 'I was examined by Orthodontist Dr. Esra Pilancı for clear aligner treatment and a jaw joint problem. Thanks to her sincere approach and detailed explanations, all my questions were fully answered. I strongly recommend Dr. Esra to anyone needing dental or jaw treatment.' },
        { name: 'Arzu Aygün', initials: 'AA', color: '#11665f', stars: 5, tag: 'Ağrısız Tedavi', tagEn: 'Painless Treatment', text: 'M. Yasin Tekpınar hocamın titiz çalışması ve üstün nezaketi için teşekkür ederim. Hem hijyen standartlarınız hem ekibinizin ilgisi gerçekten hayranlık uyandırıcı. Acısız geçirdiğim kusursuz bir tedavi süreci yaşadım. Bugün kliniğinizden çok mutlu ayrıldım, artık çok daha özgüvenle gülümsüyorum.', textEn: 'Thank you to Dr. M. Yasin Tekpınar for his meticulous work and outstanding courtesy. Both your hygiene standards and your team\'s attentiveness are truly admirable. I went through a flawless, completely painless treatment process. I left your clinic very happy today and now smile with much more confidence.' },
